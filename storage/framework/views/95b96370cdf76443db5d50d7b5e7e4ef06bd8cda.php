  ...
  <div style="width:auto; height:60px;background: linear-gradient(to bottom, lightgray,white);position:fixed;top:0;right:0;left:0;opacity:90%;">
    ...
    <div class="col-md" style="position:fixed; top: 45px; left:45px;text-align:right;font-size: 20px;font-weight:700;color:orange;">My Favorites</div>
        ...
        ?>
              ...
              <button type="button" class="btn btn-lg" style="width:80px;background-color:rgb(34,147,240); font-size:15px;border:0px;"><a href="<?php echo e(url('/read')); ?>/<?php echo e($story->story_id); ?>" style=" color:white;text-decoration:none;">Read</a></button>
        
              </div></div>
              <p><em style="color:#674652;">By <?php echo e($author[$count]); ?></em></p>
...
</html><?php /**PATH D:\My\Xampp\htdocs\allchefs\resources\views/favorites.blade.php ENDPATH**/ ?>