    ...
    <div class="container">
     ...
     <div class="container" style="border-top:1.5px solid rgb(252, 46, 146);width:80%; margin-top: 10px;"></div>
        ...
        <div class="container" id="stories" style="width:80%;">
              ...
              <?php if(isset($favorite[$count]) && $favorite[$count]==1): ?>
              ...
              <button type="button" class="btn btn-sm" style="background-color:transparent;width:50px; padding:3px;border:0px;"><a  href="<?php echo e(url('/togglefavorites')); ?>/<?php echo e($story->story_id); ?>"style="font-size:25px; color:orange;text-decoration:none;">&#9825;</a></button>
              <?php endif; ?>
      <button type="button" class="btn btn-lg" style="width:80px;background-color:rgb(34,147,240); font-size:15px;"><a href="<?php echo e(url('/read')); ?>/<?php echo e($story->story_id); ?>" style=" color:white;text-decoration:none;">Read</a></button>
              </div></div>
              <p><em style="color:#6c4d5e;">By <?php echo e($author[$count-1]); ?></em></p>
              <p class="col-md-10"><?php echo e(substr($story->content,0,150)); ?>   .  .  .  .</p>
              <div class="row">
...
</html><?php /**PATH D:\My\Xampp\htdocs\allchefs\resources\views/index.blade.php ENDPATH**/ ?>