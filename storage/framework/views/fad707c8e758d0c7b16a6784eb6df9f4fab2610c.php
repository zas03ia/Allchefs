...
<body style="background: linear-gradient(to bottom,darkgray,white);background-repeat: no-repeat;">
    ...
    <form method="post" action="/signup">
        ...
        <div class="modal-body">
                ...
                <input type="name" name="name"style="width:375px;">
                <br><br>
        ...
        <div class="modal-footer">
                ...
                <input type="submit" value ="signup" class="btn btn-sm" style="background-color:rgb(34,147,240); font-size:15px; color:white;">
        </form>
        </div>
...
<?php /**PATH D:\My\Xampp\htdocs\allchefs\resources\views/signup.blade.php ENDPATH**/ ?>