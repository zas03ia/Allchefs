...
<div style="text-align:center;"><img src="{{ asset('images/home.png') }}" style="margin-top :80px;min-width:300px;min-height:300px;width:80%;height: 40vw;z-index:-1;" alt="User"></div>
</div>
