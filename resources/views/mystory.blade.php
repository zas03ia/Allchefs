  ...
  <div style="width:auto; height:60px;background: linear-gradient(to bottom, lightgray,white);position:fixed;top:0;right:0;left:0;opacity:90%;">
    ...
    <div class="col-md" style="position:fixed; top: 45px; left:45px;text-align:right;font-size: 20px;font-weight:700;color:orange;">My Stories</div>
        ...
        @foreach ($stories as $story)
              ...
              <div class="row"><div class="col-md" style="text-align:left;"><h4>{{rtrim($story->title,".")}}</h4></div>
              </div>
              <p>{{substr($story->content,0,150)}}   .  .  .  .</p>
              <div class="row" style="padding-bottom:5px;">
              <div class="col-lg">
              <div class="row" style="padding-bottom:5px;">
              <div class="col-md" style="color:orange;">Genre: {{$story->genre}}</div>
                <div class="col-md"style="width:100px;">{{round(strlen($story->content)/100)}}min read</div>
                <div class="col-md"style="width:200px;"> <span style="font-size:12px;color:orange;">&starf;</span>{{$story->avg_rating}} &nbsp; ({{$story->num_rating}} ratings)</div>
              </div></div>
                <div class="col-md-1"style="width:52px;"><a href="{{url('/read')}}/{{$story->story_id}}"><button type="button" class="btn btn-sm" style="background-color:rgb(34,147,240); font-size:15px; color:white;">View</button></a></div>
              <div class="col-md-1" style="width:45px;"><a href="{{url('/edit')}}/{{$story->story_id}}" target="_blank"><button type="button" class="btn btn-sm" style="background-color:gray; font-size:15px; color:white;">Edit</button></a></div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{url('/')}}/delete" method="post">
                            @csrf
                            <input type="hidden" name="del_id" value="{{$story->story_id}}">
